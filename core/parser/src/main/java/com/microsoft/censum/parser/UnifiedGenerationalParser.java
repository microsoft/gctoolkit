...
import com.microsoft.censum.event.generational.AbortablePreClean;
import com.microsoft.censum.event.generational.CMSConcurrentEvent;
import com.microsoft.censum.event.generational.CMSRemark;
import com.microsoft.censum.event.generational.ConcurrentMark;
import com.microsoft.censum.event.generational.ConcurrentModeFailure;
import com.microsoft.censum.event.generational.ConcurrentPreClean;
import com.microsoft.censum.event.generational.ConcurrentReset;
import com.microsoft.censum.event.generational.ConcurrentSweep;
import com.microsoft.censum.event.generational.DefNew;
import com.microsoft.censum.event.generational.FullGC;
import com.microsoft.censum.event.generational.GenerationalGCPauseEvent;
import com.microsoft.censum.event.generational.InitialMark;
import com.microsoft.censum.event.generational.PSFullGC;
import com.microsoft.censum.event.generational.PSYoungGen;
import com.microsoft.censum.event.generational.ParNew;
import com.microsoft.censum.event.generational.YoungGC;
import com.microsoft.censum.event.jvm.JVMTermination;
import com.microsoft.censum.parser.collection.RuleSet;
...
import static com.microsoft.censum.event.GarbageCollectionTypes.*;
