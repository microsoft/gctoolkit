...
import com.microsoft.censum.event.jvm.ApplicationConcurrentTime;
import com.microsoft.censum.event.jvm.ApplicationStoppedTime;
...
public class UnifiedJVMEventParser extends UnifiedGCLogParser implements JVMPatterns {
    ...
    protected void process(String line) {
        ...
        try {
            ...
            } else if (line.equals(END_OF_DATA_SENTINAL) || (JVM_EXIT.parse(line) != null)) {
